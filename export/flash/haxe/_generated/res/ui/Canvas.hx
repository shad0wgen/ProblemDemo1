...
class Canvas extends openfl.display.MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (107);
...
#else
@:bind @:native("res.ui.Canvas") class Canvas extends openfl.display.MovieClip {
