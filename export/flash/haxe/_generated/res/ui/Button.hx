...
class Button extends openfl.display.MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (113);
...
#else
@:bind @:native("res.ui.Button") class Button extends openfl.display.MovieClip {
