...
class LeftButton extends openfl.display.MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (125);
...
#else
@:bind @:native("res.ui.LeftButton") class LeftButton extends openfl.display.MovieClip {
