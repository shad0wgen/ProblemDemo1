...
class RightButton extends openfl.display.MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (89);
...
#else
@:bind @:native("res.ui.RightButton") class RightButton extends openfl.display.MovieClip {
